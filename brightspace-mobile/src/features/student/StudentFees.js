      ...
      <View style={styles.overlay}>
        <View style={styles.sheet}>
          ...
          <View style={styles.sheetHeader}>
            <View style={styles.sheetHeading}><AppText style={styles.eyebrow}>VOUCHER DETAILS</AppText><AppText variant="heading">{item.voucher_no}</AppText><AppText style={styles.sheetType}>{voucherType(item)}</AppText></View>
