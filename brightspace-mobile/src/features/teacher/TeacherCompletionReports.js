...
const styles = StyleSheet.create({
  ...
  backdrop:{flex:1,justifyContent:"flex-end",backgroundColor:"rgba(0,39,30,.35)"},sheet:{height:"90%",padding:space.lg,paddingBottom:space["2xl"],borderTopLeftRadius:radius.xl,borderTopRightRadius:radius.xl,backgroundColor:colors.background},sheetHead:{flexDirection:"row",alignItems:"center",justifyContent:"space-between",marginBottom:space.md},sheetCopy:{flex:1},sheetTitle:{color:colors.primary,fontFamily:fonts.displayBold,fontSize:fontSize.xl},sheetMeta:{marginTop:2,color:colors.emeraldMid,fontSize:fontSize.xs},close:{width:38,height:38,alignItems:"center",justifyContent:"center",borderRadius:19,backgroundColor:colors.surfaceHigh},
